...
function BootcampSalesContent() {
  ...
  return (
    ...
    <div className="bg-[#05080f] text-slate-900 antialiased selection:bg-[#3B82F6] selection:text-white relative font-sans break-keep overflow-x-hidden pb-24 md:pb-0">
      ...
      <div className="fixed top-4 left-4 md:top-6 md:left-6 z-50 flex items-center gap-1 sm:gap-2 shrink-0">
        <button
          type="button"
          onClick={handleSmartBack}
          className="group flex items-center gap-1 px-2.5 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2.5 bg-black/50 backdrop-blur-md border border-white/20 rounded-full shadow-lg hover:bg-black/70 transition-all duration-300 ease-lux whitespace-nowrap shrink-0"
          title="이전 화면으로 이동"
        >
          <span className="text-white/70 group-hover:text-white transition-transform group-hover:-translate-x-0.5 ease-lux text-xs">←</span>
          <span className="text-white/90 group-hover:text-white text-xs md:text-sm font-bold tracking-wide">뒤로</span>
        </button>

        <Link
          href="/"
          className="flex items-center gap-1 px-2.5 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow-lg hover:bg-white/20 text-white text-xs md:text-sm font-bold transition-all duration-300 ease-lux whitespace-nowrap shrink-0"
        ...
        <a
          ...
          className="flex items-center gap-1 px-2.5 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-cyan-600/70 to-indigo-600/70 hover:from-cyan-500 hover:to-indigo-500 text-white rounded-full shadow-lg text-xs md:text-sm font-bold border border-cyan-400/30 transition-all duration-300 ease-lux whitespace-nowrap shrink-0"
