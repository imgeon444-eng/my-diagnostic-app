          ...
          {step === 0 && (
            <div className="animate-fade-in-up flex flex-col items-center justify-center h-full text-center mt-8">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white leading-tight mb-6 tracking-tight break-keep">
                비즈니스 & 메타인지<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 drop-shadow-sm">심층 진단 대시보드</span>
              </h2>
              ...
              <div className="bg-black/20 border border-white/5 p-5 md:p-6 rounded-2xl mb-10 text-left relative overflow-hidden">
                ...
                <p className="text-slate-400 leading-relaxed text-[15px] md:text-base font-medium break-keep pl-2">
                  현재 상태에 맞는 진단을 선택하세요. <strong className="text-blue-400">마케팅 퍼널 체급 점검</strong>부터 <strong className="text-cyan-400">AI 메타인지 분석</strong>까지 완벽한 솔루션을 도출합니다.
                </p>
              </div>
              ...
              <div className="w-full space-y-4">
                ...
                {/* 2. AI 메타인지 진단 버튼 (방금 이식한 2.5층 게이트) */}
                <Link 
                  href="/synergy-test" 
                  className="group w-full h-16 bg-transparent border border-cyan-500/30 text-cyan-300 hover:text-cyan-100 rounded-2xl font-bold text-base transition-all duration-300 flex items-center justify-center gap-2 hover:bg-cyan-500/10 hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.2)]"
                >
                  <svg className="w-5 h-5 opacity-80 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                  AI 메타인지 진단하기
                </Link>
                ...
                {/* 3. 2층 URL 진단기 라우팅 버튼 (비용 누수 진단 & 적합성 판별) */}
                <Link 
                  href="/bootcamp-funnel" 
                  className="group w-full h-14 bg-[#0B1120] border border-indigo-500/30 text-indigo-300 rounded-xl font-bold text-sm md:text-base transition-all duration-300 shadow-md flex items-center justify-center gap-2 hover:border-indigo-400 hover:text-indigo-100 hover:shadow-[0_0_15px_rgba(99,102,241,0.3)]"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-300">내 채널 비용 누수 진단 & 부트캠프 적합성 확인</span>
